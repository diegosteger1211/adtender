...
export default function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <aside className="w-60 flex-shrink-0 bg-[#1A2234] flex flex-col h-screen sticky top-0">
      {/* Logo */}
      ...
      <div className="px-3 py-4 border-t border-white/10">
        ...
        <button
          ...
          title="Abmelden"
          className="w-full flex items-center gap-2 px-2 py-2 mt-1 rounded-lg text-white/40 hover:text-white hover:bg-white/10 text-xs transition-colors"
        >
          <LogOut size={13} />
          Abmelden
        </button>
