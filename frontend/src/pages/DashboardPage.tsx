                ...
                <div className="space-y-3">
                  {recentProjects.map(p => (
                    <div
                      ...
                      className="bg-white border border-gray-200 hover:border-blue-300 shadow-sm rounded-xl p-5 cursor-pointer transition-all group"
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className="text-gray-900 text-sm font-semibold truncate group-hover:text-blue-600 transition-colors">
                              {p.title}
                            </h3>
